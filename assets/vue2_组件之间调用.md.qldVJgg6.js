import{_ as s,o as n,c as a,R as l}from"./chunks/framework.BMSw91m9.js";const u=JSON.parse('{"title":"组件通讯","description":"","frontmatter":{},"headers":[],"relativePath":"vue2/组件之间调用.md","filePath":"vue2/组件之间调用.md"}'),p={name:"vue2/组件之间调用.md"},e=l(`<h1 id="组件通讯" tabindex="-1">组件通讯 <a class="header-anchor" href="#组件通讯" aria-label="Permalink to &quot;组件通讯&quot;">​</a></h1><p><strong>在子组件中调用父组件的方法</strong></p><p>方法一:不推荐使用 不易维护 X</p><p>子组件.vue</p><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">script</span><span style="color:#E1E4E8;">&gt;</span></span>
