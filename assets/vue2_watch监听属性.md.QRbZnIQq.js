import{_ as s,o as a,c as n,R as l}from"./chunks/framework.xiFMR0TK.js";const m=JSON.parse('{"title":"watch监听属性","description":"","frontmatter":{},"headers":[],"relativePath":"vue2/watch监听属性.md","filePath":"vue2/watch监听属性.md"}'),p={name:"vue2/watch监听属性.md"},e=l(`<h1 id="watch监听属性" tabindex="-1">watch监听属性 <a class="header-anchor" href="#watch监听属性" aria-label="Permalink to &quot;watch监听属性&quot;">​</a></h1><p>深度监听</p><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> {</span></span>
